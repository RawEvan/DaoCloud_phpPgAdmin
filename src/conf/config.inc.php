<?php
	...
	$conf['servers'][0]['host'] = $_ENV['POSTGRESQL_PORT_5432_TCP_ADDR'];

	// Database port on server (5432 is the PostgreSQL default)
	$conf['servers'][0]['port'] = $_ENV['POSTGRESQL_PORT_5432_TCP_PORT'];
	...
	$conf['servers'][0]['defaultdb'] = $_ENV['POSTGRESQL_INSTANCE_NAME'];
