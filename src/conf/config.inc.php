<?php
	...
	$conf['servers'][0]['host'] = getenv('POSTGRESQL_PORT_5432_TCP_ADDR');

	// Database port on server (5432 is the PostgreSQL default)
	$conf['servers'][0]['port'] = getenv('POSTGRESQL_PORT_5432_TCP_PORT');
	...
	$conf['servers'][0]['defaultdb'] = getenv('POSTGRESQL_INSTANCE_NAME');
